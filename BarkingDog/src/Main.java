...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("shouldWakeUp (true, 1): " + test1);
        boolean test2 = BarkingDog.shouldWakeUp(false, 2);
        System.out.println("shouldWakeUp (false, 2): " + test2);
        boolean test3 = BarkingDog.shouldWakeUp(true, 8);
        System.out.println("shouldWakeUp (true, 8): " + test3);
        boolean test4 = BarkingDog.shouldWakeUp(true, -1);
        System.out.println("shouldWakeUp (true, -1): " + test4);
    }
}